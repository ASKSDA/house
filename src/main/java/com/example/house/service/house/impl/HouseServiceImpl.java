...
public class HouseServiceImpl implements IHouseService {
    ...
    public ServiceResult update(HouseForm houseForm) {
        ...
        HouseDetail detail = this.houseDetailMapper.findByHouseId(houseForm.getId());
        if(detail == null){
            return ServiceResult.notFound();
        }
    ...
    public ServiceResult<HouseDTO> findCompleteOne(Long id) {
        ...
        List<HouseTag> houseTags = houseTagMapper.findAllByHouseId(id);
    ...
    public ServiceResult removeTag(Long houseId, String tag) {
        House house = houseMapper.findOne(houseId);
        if(house == null){return ServiceResult.notFound();}
    ...
    public ServiceResult updateStatus(Long id, int status) {
        ...
        if(house.getStatus() == status){return new ServiceResult(false,"状态没有发生变化");}

        if(house.getStatus() == HouseStatus.RENTED.getValue()){
            return new ServiceResult(false,"房屋已出租不能更改状态");
        }
    ...
    public ServiceResult removePhoto(Long id) {
        ...
        if (picture == null) {return ServiceResult.notFound();}
...
//        Pageable pageable = PageRequest.of(page, searchBody.getLength(), sort);
    ...
    private List<HousePicture> generatePictures(HouseForm houseForm, Long houseId) {
        ...
        for(PhotoForm photoForm : houseForm.getPhotos()){
            ...
            picture.setHeight(picture.getHeight());
